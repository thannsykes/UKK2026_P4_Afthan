...
<div class="container-fluid">
  ...
  <div class="d-flex align-items-center gap-2 mb-4">
    ...
    <h5 class="fw-bold mb-0">Tambah Rak</h5>
  </div>
  ...
  <div class="card">
    <div class="card-body">
      ...
      <form method="POST" action="{{ route('admin.rak.store') }}">
        @csrf
        ...
        <div class="row g-3" style="max-width:600px">
          <div class="col-12">
            ...
            <input type="text" name="nama_rak"
                   ...
                   value="{{ old('nama_rak') }}"
                   placeholder="Contoh: Rak A1, Rak Fiksi" required>
            @error('nama_rak') <div class="invalid-feedback">{{ $message }}</div> @enderror
          </div>

          <div class="col-12">
            <label class="form-label">Lokasi <span class="text-muted small">(opsional)</span></label>
            <input type="text" name="lokasi"
                   class="form-control @error('lokasi') is-invalid @enderror"
                   value="{{ old('lokasi') }}"
                   placeholder="Contoh: Lantai 1, Sudut Kiri">
