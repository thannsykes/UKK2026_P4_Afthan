        ...
        <div class="card-body">
          ...
          <div class="d-flex align-items-start gap-3 p-3 bg-light rounded mb-4">
            ...
            <div>
              ...
              @if($buku->penerbit)
              <div class="text-muted small">{{ $buku->penerbit }} {{ $buku->tahun ? '(' . $buku->tahun . ')' : '' }}</div>
              @endif
              <span class="badge bg-success mt-1">Stok: {{ $buku->stok }}</span>
            </div>
          </div>
          ...
          <form method="POST" action="{{ route('anggota.pinjam.store') }}">
            ...
            <div class="mb-4">
              ...
              <div class="text-muted small mt-1">Minimal 1 hari, maksimal 30 hari</div>
            </div>
            ...
            <div class="alert alert-info py-2 mb-4" id="preview-tanggal">
              ...
              Perkiraan tanggal kembali: <strong id="tgl-kembali"></strong>
            </div>
            ...
            <div class="d-grid gap-2">
              ...
              <a href="{{ route('anggota.buku.index') }}" class="btn btn-outline-secondary">Batal</a>
            </div>
          </form>
...
<script>
  ...
  updateTanggal(); // jalankan saat halaman dimuat
</script>
@endpush